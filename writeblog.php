...
<body>
    ...
    <div class="navigation">
        ...
        <a class="active" href="writeblog.php">Write Blog</a>
    ...
    <form action="writeblog.php" method="post" enctype="multipart/form-data">
        ...
        <div class="input">
            <label for="title">Image of Blog</label>
        ...
        <p id="error">
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if ($_FILES["img"]["error"]) {
                    ...
                    echo 'Please provide a body';
                } else {
                    $explode = explode('.', $fileName);
                    $fileNewName = uniqid() . '.' . strtolower(end($explode));
                    $fileDestination = 'uploads/' . $fileNewName;
                    move_uploaded_file($_FILES["img"]["tmp_name"], $fileDestination);
                    $sql = "INSERT INTO `blogs` (`title`, `body`, `img`, `date`, `blogid`) VALUES ('$title', '$body', '$fileDestination', '$date', '$id')";
                    $result = $conn->query($sql);
                    if ($result) {
                        echo 'Successfully uploaded Blog';
                    } else {
