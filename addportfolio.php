...
<body>
    ...
    <div class="navigation">
        ...
        <a class="active" href="addportfolio.php">Add Portfolio</a>
    ...
    <form action="addportfolio.php" method="post" enctype="multipart/form-data">
        ...
        <div class="form">
            ...
            <div class="input">
                <label for="">Image of Portfolio</label>
            ...
            <p id="error">
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    if ($_FILES["img"]["error"]) {
                        ...
                        $sql = "INSERT INTO `portfolio` (`title`, `image`) VALUES ('$title', '$fileDestination')";
                        $result = $conn->query($sql);
                        if ($result) {
                            echo 'Successfully uploaded Portfolio';
                        }
                    }
                    $conn->close();
                }
